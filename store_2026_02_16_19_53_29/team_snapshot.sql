...
--
-- WHERE:  id IN (SELECT DISTINCT team_id FROM new_player WHERE combo = 1 AND name NOT LIKE '%+%')

LOCK TABLES `team` WRITE;
/*!40000 ALTER TABLE `team` DISABLE KEYS */;
INSERT INTO `team` VALUES (3477,'Brentford','Brentford','Brentford FC'),(3534,'Roma','Roma','AS Roma');
...
-- Dump completed on 2026-02-16 19:53:29
